...
//END FERMI MOTION PART
        ...
        else
	{
      ...
      if(trk.Process == 0 && xsec>rndm.Rndm()*50)dump_file(ro->get_fMode(), ro->get_fProc(),xsec);
      if(trk.Process == 1 && xsec>rndm.Rndm()*6000)dump_file(ro->get_fMode(), ro->get_fProc(),xsec);
    }//if(ro->get_Ascii() != 0)
